...
from src.api import api_router # Importa el api_router de tu nueva estructura
from src.core.database import Base, engine # Para la creación de tablas (si no usas migraciones)
from src.models import * # Importa todos los modelos para que Base.metadata.create_all() los detecte
