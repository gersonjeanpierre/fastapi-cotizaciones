# src/api/v1/endpoints/customer.py
from fastapi import APIRouter, Depends, HTTPException, status
from sqlalchemy.orm import Session
from typing import List

from src.schemas import customer as schemas
from src.crud import customer as crud # Importa las funciones CRUD
from src.core.database import get_db # Importa la dependencia de la DB
